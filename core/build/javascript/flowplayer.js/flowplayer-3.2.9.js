...
// {{{ public methods
	...
	// event handlers
	each(("Click*,Load*,Unload*,Keypress*,Volume*,Mute*,Unmute*,PlaylistReplace,ClipAdd,Fullscreen*,FullscreenExit,Winodwmode*,WinodwmodeExit,Error,MouseOver,MouseOut").split(","),
		function() {
			var name = "on" + this;
