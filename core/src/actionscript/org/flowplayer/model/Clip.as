...
package org.flowplayer.model {
	...
	public class Clip extends ClipEventDispatcher implements Extendable {
		...
		private var _publish:Boolean = false;
        ...
        public function Clip() {
			...
			_scaling = MediaSize.FITTED_PRESERVING_ASPECT_RATIO;
			_provider = "http";
			_smoothing = true;
			_fadeInSpeed = 1000;
			_fadeOutSpeed = 1000;
...
//				log.warn("Getting height from a clip that does not have content loaded yet, returning zero");
		...
		[Value]		
		public function get publish():Boolean {
			return _publish;
		}
		
		public function set publish(v:Boolean):void {
			_publish = v;
		}
