...
import flash.utils.Timer;
    ...
    public class RotatingAnimation extends AbstractSprite {
        private var _rotationBjImage:BufferAnimationBj;
        private var _rotationBj:Sprite;
        ...
        private function createRotation():void {
            _rotationBjImage = new BufferAnimationBj();
            _rotationBj = new Sprite();
            _rotationBj.addChild(_rotationBjImage);
            addChild(_rotationBj);
