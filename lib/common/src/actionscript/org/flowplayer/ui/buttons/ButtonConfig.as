...
package org.flowplayer.ui.buttons {
    ...
    public class ButtonConfig {
        ...
        private var _disableFontColor:String;

		public static function defaultConfig():ButtonConfig {
            ...
            config.setDisableFontColor("#ff0000");
        ...
        public function  setDisableFontColor(color:String): void {
		...
		public function setEnabled(value:Boolean):void {
			_enabled = value;
            if (_enabled) setFontColor(_color); else setFontColor(_disableFontColor);
		}
    }
}