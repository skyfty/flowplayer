package org.flowplayer.quickmenu {
	...
	import org.flowplayer.quickmenu.controllers.*;
    ...
    public class QuickMenubar extends StyleableSprite {
        ...
        public function QuickMenubar(player:Flowplayer, config:Config) {
			_player = player;
			_config = config;
        ...
        private function createChildren():void {
            ...
            addWidget(new ToggleOptionDialogButtonController(), null, false);
