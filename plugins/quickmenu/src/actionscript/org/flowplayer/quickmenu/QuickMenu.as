...
package org.flowplayer.quickmenu {
	...
	import org.flowplayer.quickmenu.config.Config;
	import org.flowplayer.quickmenu.config.ToolTipsConfig;
	import org.flowplayer.quickmenu.config.WidgetsVisibility;
	import org.flowplayer.quickmenu.config.WidgetsEnabledStates;
     ...
     * @author anssi
     */
    public class QuickMenu extends StyleableSprite implements Plugin, WidgetContainer {
		...
		private var _controlbar:QuickMenubar;
		...
		public function onLoad(player:Flowplayer):void {
			...
			_controlbar = new QuickMenubar(_player, _config);
			var self:QuickMenu = this;
